    ...
    return [
        {
            ...
            "checks": [
                ...
                path_equals("runtime.briefingMode", "deterministic"),
        ...
        },
        {
            ...
            "description": "Request asks for LLM planner but local no-AWS mode returns deterministic fallback.",
            ...
            "checks": [
                ...
                path_equals("runtime.agentMode", "llm-planner"),
                path_equals("runtime.activeAgentMode", "deterministic-fallback"),
                path_equals("runtime.briefingMode", "fallback"),
                path_contains("runtime.fallbackReason", "ENABLE_BEDROCK is not true"),
                has_trace("llm_planner_model_plan", "fallback", with_fallback_reason=True),
                path_equals("modelCalls", []),
